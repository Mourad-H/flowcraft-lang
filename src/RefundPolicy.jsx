    ...
    <div className="max-w-4xl mx-auto relative z-10">
      ...
      <div className="bg-[#1e293b]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
        ...
        <div className="space-y-8 text-slate-200 leading-relaxed text-lg drop-shadow-md">
          <section>
            <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-2 neon-text">
          ...
          <section>
            ...
            <div className="bg-black/40 p-6 rounded-xl border-l-4 border-anime-warning">
              <ul className="space-y-3">
                <li className="flex gap-3">
                  <CheckCircle className="text-anime-warning shrink-0" size={24}/>
